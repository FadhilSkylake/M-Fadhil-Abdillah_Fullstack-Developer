...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="container text-center text-md-left" data-aos="fade-up">
      <h1>Welcome to <span>HOSPITAL</span></h1>
    </div>
  </section><!-- End Hero -->
  ...
  <main id="main">
    ...
    <section id="what-we-do" class="what-we-do">
      <div class="container">
        ...
        <div class="row">
            <table id="dokter" class="table table-striped" style="width:100%">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nama Dokter</th>
    ...
    <section id="pasien" class="contact section-bg">
      <div class="container">
        ...
        <div class="row mt-5 justify-content-center">
          <div class="col-lg-10">
            <form action="{{ route('landing.store') }}" method="POST" role="form" class="php-email-form">
              @csrf
              @method('POST')
              <div class="row">
