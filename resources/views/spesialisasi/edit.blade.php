  ...
  <div class=" d-flex align-items-stretch">
    <div class="card w-100">
      <div class="card-body">
        ...
        <form action="{{ route('spesialisasi.update', $spesialisasi->id_spesialisasi) }}" method="POST">
            @csrf
            @method('PUT')
        <div class="mb-3  w-25">
            <label for="nama_spesialisasi" class="form-label">Nama Spesialisasi:</label>
            <input type="text" class="form-control" id="nama_spesialisasi" name="nama_spesialisasi" value="{{ old('nama_spesialisasi', $spesialisasi->nama_spesialisasi) }}" required>
